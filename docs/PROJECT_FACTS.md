...
| `v0.2.1-public-review` is a draft pre-release evidence layer for exact main snapshot `3d5c207b133e4b86459bdc173b78422315a0c744`; it is not a published tag and does not rewrite either earlier pre-release. | `config/public-versions.json`; `config/releases/v0.2.1-public-review.json`; `docs/releases/v0.2.1-public-review.md`; `git rev-parse origin/main`. | 2026-07-12 | verified |
