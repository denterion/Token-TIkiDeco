...
| A v0.2 utility-pilot review bundle was generated for current `main` commit `e7c52e65f6a56c4a728ca81e3cb3080a25c344e7`; it must be regenerated after any later release-documentation, site, audit, or gate merge. | `docs/releases/v0.2.0-utility-pilot-rc.1.md`; `docs/reports/REPORT_2026_07_10_V02_FINAL_EVIDENCE.md`; local `npm run release -- --commit e7c52e65f6a56c4a728ca81e3cb3080a25c344e7 --release v0.2.0-utility-pilot` output. | 2026-07-10 | verified |
